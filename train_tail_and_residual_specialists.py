...
def main():
    ...
    print("=" * 70)
    print("[EXECUTE]  TRAINING STRATEGIES 4 & 5: TAIL-RISK & RESIDUAL ORTHOGONAL SPECIALISTS")
    print("=" * 70)
    ...
    print("\n[LOAD]  Loading training dataset (2.74M rows)...")
    ...
    print("\n[TRAIN]  Training Strategy 4: Tail-Risk Specialist ('target_xerxes_20')...")
    ...
    print(f"[SAVE]  Saved: {xerxes_file}")

    # 2. Strategy 5: target_delta_20
    delta_file = os.path.join(RESIDUAL_DIR, "lgb_target_delta_20.pkl")
    print("\n[TRAIN]  Training Strategy 5: Residual Specialist ('target_delta_20')...")
    ...
    print(f"[SAVE]  Saved: {delta_file}")

    del train_df, X_train

    # Validation Phase
    print("\n[METRICS]  Evaluating both strategies out-of-sample on validation eras...")
    ...
    print("\n" + "=" * 70)
    print("[AUDIT]  STRATEGIES 4 & 5 AUDIT SUMMARY")
    print("=" * 70)
    ...
    print("=" * 70)
    print("[SUCCESS]  All 5 Fleet Strategy Archetypes Trained Successfully!\n")
